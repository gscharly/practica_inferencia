...
Este tipo de contraste se realiza sobre variables categóricas. De esta forma, lo primero que realizamos es la categorización de la variable correspondiente a los suicidios en base a los cuartiles de manera que obtenemos cuatro categorías.
...
for (i in 1:nrow(datosFemale)){
  if(datosFemale[i,'suicides_100k_pop']<= quantileFem1){
    datosFemale[i,'suicides_100k_category'] = 'Menos del 0.98%'
  }
  else if (datosFemale[i,'suicides_100k_pop']> quantileFem1 && 
           datosFemale[i,'suicides_100k_pop']<= quantileFem2){
    datosTotales[i,'suicides_100k_category'] = 'Entre el 0.98% y el 6.52%'
  }
  else if (datosFemale[i, 'suicides_100k_pop']> quantileFem2 && 
           datosFemale[i, 'suicides_100k_pop']<= quantileFem3){
    datosFemale[i,'suicides_100k_category'] = 'Entre el 6.52% y el 17.78%'
  }
  else{
    datosFemale[i,'suicides_100k_category'] = 'Más del 17.78%'
  }
}
knitr::kable(table(datosMale$age, datosMale$suicides_100k_category))
#Chi-cuadrado
chisq.test(datosFemale$age, datosFemale$suicides_100k_category)
```
...
for (i in 1:nrow(datosMale)){
  if(datosMale[i,'suicides_100k_pop']<= quantileMale1){
    datosMale[i,'suicides_100k_category'] = 'Menos del 0.98%'
  }
    ...
    datosMale[i,'suicides_100k_category'] = 'Entre el 6.52% y el 17.78%'
  }
  else{
    datosMale[i,'suicides_100k_category'] = 'Más del 17.78%'
  }
}
knitr::kable(table(datosMale$age, datosMale$suicides_100k_category))
#Chi-cuadrado
chisq.test(datosMale$age, datosMale$suicides_100k_category)
```
