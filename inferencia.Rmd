...
Debido a lo observado respecto a la aparición de outliers en las muestras, se ha optado por realizar nuestros análisis sobre el número de suicidios por cada 100.000 habitantes.
...
Se ha calculado el intervalo para la media de suicidios por cada 100.000 habitantes en la muestra de hombres dada la varianza poblacional conocida y con una confianza de 0.9. Como estimador de la media, se utiliza la media muestral, suponiendo que extraemos los datos de una población con distribución normal, media desconocida y varianza conocida.
...
Este tipo de contraste se realiza sobre variables categóricas. De esta forma, lo primero que realizamos es la categorización de la variable PIB per cápita en base a los cuartiles de manera que obtenemos cuatro categorías. Se ha elegido esta manera de categorización porque obtendremos categorías con aproximadamente la misma cantidad de muestras.
...
```
Podemos rechazar la hipótesis nula, es decir, la media de la tasa de suicidios por cada 100.000 habitantes en la muestra no es igual a la característica en la población total.
...
El p-valor obtenido es menor para cualquier $\alpha$ de los habituales (0.1, 0.05 o 0.025) por lo que podemos rechazar la hipótesis nula y afirmar que los datos no siguen una distribución normal. Esto mismo puede verse de manera gráfica en el siguiente histograma y en gráfico Quantil-Quantil.
